...
<head>
    ...
    <meta name="description" content="Apocrat für Privatpersonen">

    <link href="https://www.apocrat.at/privatpersonen" rel="canonical">
</head>
<body>

<?php include 'includes/headernav.inc' ?>
<div class="hero px-2 md:px-0" style="background-position: center bottom;background-size: cover;background: url('./img/Bilder_Webseite/processed/roberto-nickson-q9nZUFC1nTw-unsplash_processed.jpg');">
...
<div class="content-block">
    <div class="container">
        <h2 class="text-underline text-underline--center text-center">Hol dir zurück, was dir zusteht</h2>
        <div class="flex flex-col md:flex-row">
            ...
            <div class="w-full md:w-1/3 md:px-2 mt-8 md:mt-0 text-center">
                <div class="square mx-auto">
                    <div class="square__image">
                        <img src="/img/Icons Webseite/lock.png" width="90px" alt="lock icon"/>
                    </div>
                </div>
...
<div class="content-block bg-gray-100 py-8">
    <div class="container">
        ...
        <div class="flex flex-col md:flex-row">
            <div class="w-full md:w-1/2 mx-auto px-4 mt-8 md:mt-0 flex flex-col justify-center" style="min-height: 256px; background-image: url('img/Bilder_Webseite/processed/nathan-dumlao-Y3AqmbmtLQI-unsplash_processed.jpg');background-position: center; background-repeat: no-repeat; background-size: cover">
...
<div class="bg-gray-100 py-8">
    <div class="container">
        <div class="flex flex-col md:flex-row">
            <div class="w-full md:w-1/2 mx-auto px-4 mt-8 md:mt-0 flex flex-col justify-center" style="min-height: 256px; background-image: url('img/Bilder_Webseite/processed/jonas-leupe-dZmNJKFDuVI-unsplash_processed.jpg');background-position: center; background-repeat: no-repeat; background-size: cover">
            ...
            <div class="w-full md:w-1/2 mx-auto px-4 flex flex-col justify-center">
                <h3 class="h4">Nicht nur Kriminelle sind das Problem</h3>
                <p class="mt-2">
