...
<head>
    <meta charset="utf-8">
    <title>Datenschutz | Apocrat</title>
    ...
    <link href="https://www.apocrat.at/datenschutz" rel="canonical">
...
<div class="container mt-16">
    <h1 class="text-underline text-blue text-md mb-8 text-bold text-lg">Datenschutzerklärung</h1>
    <h2 class="mt-4 text-base">
        Datenschutz
    </h2>
    <p>
        Wir haben diese Datenschutzerklärung (Fassung 24.11.2020-211136709) verfasst, um Ihnen gemäß der Vorgaben der <a href="https://eur-lex.europa.eu/legal-content/DE/ALL/?uri=celex:32016R0679&&tid=211136709" class="text-blue underline">Datenschutz-Grundverordnung (EU) 2016/679</a> zu erklären, welche Informationen wir sammeln, wie wir Daten verwenden und welche Entscheidungsmöglichkeiten Sie als Besucher dieser Webseite haben.
    </p>
    <p>
        Leider liegt es in der Natur der Sache, dass diese Erklärungen sehr technisch klingen, wir haben uns bei der Erstellung jedoch bemüht die wichtigsten Dinge so einfach und klar wie möglich zu beschreiben.
    </p>

    <h2 class="mt-12 text-base">
    ...
    <p>
        Ihnen stehen laut den Bestimmungen der DSGVO und des österreichischen <a href="https://www.ris.bka.gv.at/GeltendeFassung.wxe?Abfrage=Bundesnormen&Gesetzesnummer=10001597&tid=211136709" target="_blank">Datenschutzgesetzes (DSG)</a> grundsätzlich die folgende Rechte zu:
    </p>
    ...
    <p>
        Wenn Sie glauben, dass die Verarbeitung Ihrer Daten gegen das Datenschutzrecht verstößt oder Ihre datenschutzrechtlichen Ansprüche sonst in einer Weise verletzt worden sind, können Sie sich bei der Aufsichtsbehörde beschweren, welche in Österreich die Datenschutzbehörde ist, deren Webseite Sie unter <a href="https://www.dsb.gv.at/" target="_blank">https://www.dsb.gv.at/</a> finden.
    </p>
    ...
    <p>
        Wir verwenden https um Daten abhörsicher im Internet zu übertragen (Datenschutz durch Technikgestaltung <a href="https://eur-lex.europa.eu/legal-content/DE/TXT/HTML/?uri=CELEX:32016R0679&from=DE&tid=211136709" target="_blank">Artikel 25 Absatz 1 DSGVO)</a>. Durch den Einsatz von TLS (Transport Layer Security), einem Verschlüsselungsprotokoll zur sicheren Datenübertragung im Internet können wir den Schutz vertraulicher Daten sicherstellen. Sie erkennen die Benutzung dieser Absicherung der Datenübertragung am kleinen Schlosssymbol links oben im Browser und der Verwendung des Schemas https (anstatt http) als Teil unserer Internetadresse.
    </p>
    ...
    <p class="mt-4 mb-16">Quelle: Erstellt mit dem Datenschutz Generator von <a href="https://www.firmenwebseiten.at/datenschutz-generator/" target="_blank">firmenwebseiten.at</a> in Kooperation mit <a href="https://www.wallentin.cc/" target="_blank">wallentin.cc</a></p>
</div>
